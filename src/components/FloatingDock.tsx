...
import { Briefcase, Zap, Code2, Sparkles } from "lucide-react";
            ...
            >
                <div className="flex items-center gap-1">
                    {navItems.map((item) => (
                        ...
                        >
                            <item.icon size={24} className="text-gray-500 hover:text-black transition-colors" />
                            <AnimatePresence>
                                {hovered === item.name && (
                                    <motion.span
                                        ...
                                        className="overflow-hidden whitespace-nowrap text-sm font-bold text-black"
                                    >
                                        {item.name}
                                    </motion.span>
                                )}
